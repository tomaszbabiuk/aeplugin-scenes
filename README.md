...
git clone https://github.com/tomaszbabiuk/aeplugin-scenes.git
```
...
```
After running the server, go to http://localhost/plugins/objects and enable "Scenes" plugin
...
Before lunch:
 - run gradle task: aeplugin-scenes:buildForAutomateEverything
